...
def help_msg(): #help message
    ...
    print()
    print("COMMANDS")
    print("octoprint-cli help                                                           view this help message")
    print("octoprint-cli version                                                        view OctoPrint server version")
    print("octoprint-cli print status                                                   view print status")
    print("octoprint-cli print start                                                    start printing loaded file")
    print("octoprint-cli print select [file]                                            load file to be printed")
    print("octoprint-cli print pause                                                    pause print")
    print("octoprint-cli print resume                                                   resume print if paused")
    print("octoprint-cli print cancel                                                   cancel current print")
    print("octoprint-cli system shutdown                                                shutdown server")
    print("octoprint-cli system reboot                                                  reboot server")
    print("octoprint-cli system restart                                                 restart OctoPrint server")
    print("octoprint-cli system restart-safe                                            restart OctoPrint server to safe mode")
    print("octoprint-cli files list                                                     list files in the root OctoPrint directory")
    print("octoprint-cli files list [dir]                                               list files in directory")
    print("octoprint-cli files info [file]                                              find information about file or directory")
    print("octoprint-cli temp status                                                    find printer temperature information")
    print("octoprint-cli temp extruder [temp]                                           set extruder temperature")
    print("octoprint-cli temp bed [temp]                                                set bed temperature")
    print("octoprint-cli connection status                                              view printer connection status")
    print("octoprint-cli connection connect [port /dev/ttyACM0] [baudrate 115200]       connect to printer")
    print("octoprint-cli connection disconnect                                          disconnect from printer")
    sys.exit(0)
